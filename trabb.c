/* PEDRO GABRIEL GREGORIO INHESTA 
24496326-2*/
...
int main() {
    ...
    do {
        ...
        switch (opcao) {
            case 1: inverter_vetor(); break;
            case 2: verificar_palindromo(); break;
            case 3: desfazer_refazer(); break;
            case 4: remover_pares(); break;
            case 5: ordenar_pilha(); break;
